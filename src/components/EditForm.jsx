...
import './css/EditForm.css'; // Стили для этой формы

// --- Иконки для кнопок (вставляем прямо сюда для простоты) ---
...
function EditForm({ task, onUpdateTask, onCancelEdit }) {
  ...
  // Инициализируем их текущими данными из задачи
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Вызываем функцию обновления из App.jsx
